...
const sectionHelpText: Record<(typeof sectionKeys)[number], string> = {
  hero: "Top hero visual at the start of homepage. You can set image URL and optional click link.",
  announcement: "Announcement strip messages. Use metadata.items as an array of short strings.",
  do_you_know: "Educational carousel heading/subheading block.",
  why_auraville: "Brand story section with title/body and optional image override.",
  usp_features: "Feature badges section. Use metadata.labels as an array of feature labels.",
  faq: "FAQ section heading. Use metadata.items with objects: [{\"q\":\"...\",\"a\":\"...\"}].",
  reviews: "Customer reviews section heading and subtitle.",
  footer: "Footer content block. Body maps to the footer brand description."
};
...
function getSectionCompletenessWarning(
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-1 text-xs">
                      ...
                      >
                        {section.isActive ? "Live / Active" : "Inactive"}
                      </span>
                    </p>
                  </div>
                  <Button
