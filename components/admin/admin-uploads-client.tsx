...
export function AdminUploadsClient() {
  ...
  const [isCopyingLabel, setIsCopyingLabel] = useState<string | null>(null);
          ...
          <div className="mt-4 grid gap-3">
            <div className="rounded-lg border border-[var(--line)] bg-[var(--mint)] p-3">
              ...
              <Button
                ...
                type="button"
                variant="utility"
                disabled={isCopyingLabel === "URL"}
                onClick={() => void copyToClipboard(latestUpload.url, "URL")}
              >
                {isCopyingLabel === "URL" ? "Copying..." : "Copy URL"}
              </Button>
            </div>
            ...
            <div className="rounded-lg border border-[var(--line)] bg-[var(--mint)] p-3">
              ...
              <Button
                ...
                type="button"
                variant="utility"
                disabled={isCopyingLabel === "Secure URL"}
                onClick={() => void copyToClipboard(latestUpload.secureUrl, "Secure URL")}
              >
                {isCopyingLabel === "Secure URL" ? "Copying..." : "Copy Secure URL"}
              </Button>
            </div>
            ...
            <div className="rounded-lg border border-[var(--line)] bg-[var(--mint)] p-3">
              ...
              <Button
                ...
                type="button"
                variant="utility"
                disabled={isCopyingLabel === "Public ID"}
                onClick={() => void copyToClipboard(latestUpload.publicId, "Public ID")}
              >
                {isCopyingLabel === "Public ID" ? "Copying..." : "Copy Public ID"}
              </Button>
            </div>
          </div>
